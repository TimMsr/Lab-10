...
public class Lab10 {
    ...
    public static void Q2() {
        ...
        //Question 2 Problem: Prints days even if month of february only has 28 days
        //Fixed by making if statements which print invalid if day is over 28 days in february and other days
        if (num == 1)
